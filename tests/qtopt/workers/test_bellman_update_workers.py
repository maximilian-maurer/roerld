...
from tests.mocks.constant_prediction_model_mock import ConstantPredictionModelMock
from tests.mocks.sum_prediction_model_mock import SumPredictionModelMock
...
def test_action_selection():
    q1, q2 = SumPredictionModelMock("obs", "actions"), ConstantPredictionModelMock(1e9)
    input_dict, input_spec = _generate_sample_data_pattern()

    bellman_updater = BellmanUpdaterWorker(
...
def test_correct_q_network_chosen():
    q1, q2 = ConstantPredictionModelMock(2), SumPredictionModelMock("obs", "actions")
    input_dict, input_spec = _generate_sample_data_pattern()
...
def test_double_clipped():
    q1, q2 = ConstantPredictionModelMock(1), ConstantPredictionModelMock(2)
    input_dict, input_spec = _generate_sample_data_pattern()
    ...
    q1, q2 = ConstantPredictionModelMock(3), ConstantPredictionModelMock(2)
    input_dict, input_spec = _generate_sample_data_pattern()
